...
import OwleeeNFT from "../artifacts/contracts/OwleeeNFT.sol/OwleeeNFT.json";
  ...
  async function uploadingFile() {
    ...
    if (typeof window.ethereum !== "undefined") {
      ...
      const contract = new ethers.Contract(
        ContractAddress.owleeeNFTAddress,
        OwleeeNFT.abi,
        signer
      );
        ...
        <Wrap px="2em" py="2em">
          <Link href="https://opensea.io/account?tab=private" isExternal>
            {userData &&
              userData.map((nft) => {
                return (
                  <WrapItem mr="1em" bg="white" p="2em" rounded="10px">
                    <Stack align="center">
                      <Image height={200} width={200} src={person} />
                      <Heading
                        fontSize="30px"
                        fontWeight={500}
                        mt="10px"
