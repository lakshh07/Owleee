...
export const PK = getParamOrExit('REACT_APP_PK');

export const MUMBAI_RPC_URL = getParamOrExit('REACT_APP_MUMBAI_RPC_URL');

export const LENS_API = getParamOrExit('REACT_APP_LENS_API');

export const LENS_HUB_CONTRACT = getParamOrExit('REACT_APP_LENS_HUB_CONTRACT');

export const PROFILE_ID = getParam('REACT_APP_PROFILE_ID');
